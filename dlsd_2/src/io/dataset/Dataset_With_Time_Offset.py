...
class Dataset_With_Time_Offset(Dataset):
    ...
    def set_time_offset_numpy_array(self, time_offset_numpy_array):
        self.time_offset_numpy_array = time_offset_numpy_array
    ...
    def set_time_offsets_list(self, time_offsets_list):
        ...
        self.set_max_time_offset(max(self.time_offsets_list))

    def set_max_time_offset(self, max_time_offset):
        self.max_time_offset = max_time_offset

    def clip_data_between_indices(self, idxs):
    ...
    def _create_empty_numpy_array_of_correct_size(self):
        ...
        self.time_offset_numpy_array = self.empty_np_array(row_size, col_size)
