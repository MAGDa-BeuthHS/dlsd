class Input_And_Target_Maker_2:
	...
	def set_all_sensor_idxs_and_time_offsets_using_parameters_object(self, params):
		...
		self._check_input_target_sensor_idxs_set(self.input_maker)
		self._check_input_target_sensor_idxs_set(self.target_maker)
	...
	def _check_input_target_sensor_idxs_set(self, maker):
