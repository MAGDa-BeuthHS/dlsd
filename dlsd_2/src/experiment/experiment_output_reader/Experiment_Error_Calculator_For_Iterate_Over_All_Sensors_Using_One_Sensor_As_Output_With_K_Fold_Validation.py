...
from dlsd_2.src.experiment.experiment_output_reader.Many_Sensor_Directory_Helper import Many_Sensor_Directory_Helper_With_K_Fold_Validation
...
class Experiment_Error_Calculator_For_Iterate_Over_All_Sensors_Using_One_Sensor_As_Output_With_K_Fold_Validation(Experiment_Error_Calculator_For_Iterate_Over_All_Sensors_Using_One_Sensor_As_Output):
    def __init__(self):
        self.directory_helper = Many_Sensor_Directory_Helper_With_K_Fold_Validation()
