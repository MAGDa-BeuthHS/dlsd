...
from dlsd_2.src.experiment.experiment_helper.Experiment_Helper_Iterate_Over_All_Sensors_Using_One_Sensor_As_Output import \
    Experiment_Helper_Iterate_Over_All_Sensors_Using_One_Sensor_As_Output
from dlsd_2.src.experiment.experiment_output_reader.Experiment_Error_Calculator_For_Iterate_Over_All_Sensors_Using_One_Sensor_As_Output_With_K_Fold_Validation import \
    Experiment_Error_Calculator_For_Iterate_Over_All_Sensors_Using_One_Sensor_As_Output_With_K_Fold_Validation


class Experiment_Iterate_Over_All_Sensors_Using_One_Sensor_As_Output_With_K_Fold_Validation(
    Experiment_With_K_Fold_Validation):
    def __init__(self):
    ...
    def _set_input_target_makers_to_current_model_input_output_parameters(self):
        ...
        super(Experiment_Iterate_Over_All_Sensors_Using_One_Sensor_As_Output_With_K_Fold_Validation,
