...
from dlsd_2.src.experiment.Experiment_Config import Experiment_Config
from dlsd_2.src.experiment.experiment_helper.Experiment_Helper import Experiment_Helper
from dlsd_2.src.io.input_target_maker.Input_Target_Maker import *
...
def main():
    ...
    for i in range(0, 3):
        ...
        dir_hlpr = Experiment_Helper(exp_config)
