...
class Many_Sensors_Input__Timeoffset_Target_Tests(Input_And_Target_Maker_Tests):
    def setUp(self):
        self.correct_output_dir = 'dlsd_2/tests/input_target_maker/itm_test_csvs/correct_output/Many_Sensors_Input__Timeoffset_Target/'
        super(Many_Sensors_Input__Timeoffset_Target_Tests, self).setUp()


class Many_Sensor_Time_Offset_Timeoffset_Sensor_Target(Many_Sensors_Input__Timeoffset_Target_Tests):
    def setUp(self):
    ...
    def define_correct_output_input_target_columns(self):
        ...
        self.correct_output_reader.define_target_columns_list([2, 3, 4, 5])
