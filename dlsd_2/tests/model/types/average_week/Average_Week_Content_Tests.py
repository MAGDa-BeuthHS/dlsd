...
class AWC_Test_Calc_Average_Week(AWC_Tests):
    ...
    def setUp(self):
        ...
        self.avg_week = self.average_week_content._calculate_average_week_from_numpy_array(
            self.sample_three_weeks_df.values)
...
class AWC_Test_Opening_Preaveraged_Week_And_Creating_Target_Dataset(
    AWC_Test_Opening_Preaveraged_Week_And_Creating_Target_Dataset_Abstract):
    def setUp(self):
...
class AWC_Test_Opening_Preaveraged_Week_And_Creating_Target_Dataset_Multiple_Sensors(
    AWC_Test_Opening_Preaveraged_Week_And_Creating_Target_Dataset_Abstract):
    def setUp(self):
        self.correct_file_name = 'avg_week_target_inputs(0,1440)_outputs(1440,2880,3420).csv'
        self.incorrect_file_name = 'avg_week_target_inputs(0)_outputs(1440,2880,3420).csv'
...
class AWC_Test_Opening_Preaveraged_Week_And_Creating_Target_Dataset_Different_Day_Begin(
    AWC_Test_Opening_Preaveraged_Week_And_Creating_Target_Dataset_Abstract):
    def setUp(self):
        self.correct_file_name = 'avg_week_target_inputs(0,1440)_outputs(1440,2880,3420).csv'
        self.incorrect_file_name = 'avg_week_target_inputs(0)_outputs(1440,2880,3420).csv'
