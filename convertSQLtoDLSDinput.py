...
def getArguments():
	...
	parser.add_argument('-s','--specifiedSensors',help='python list of sensors to be extracted',required=False)
...
def main():
	...
	wide_data = stn.pivotAndSmooth(args.inputFile,
		None if args.specifiedSensors is None else pd.DataFrame(args.specifiedSensors.split(","),dtype=int))[0]
